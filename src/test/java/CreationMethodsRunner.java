...
Created by Tommy, Athulya, and Vikas 7/5/22
 */
...
public class CreationMethodsRunner {
    ...
    public static void main(String args[]) throws IOException {
        ...
        scan.nextLine();
        CM.createTable(keyspaceName,tableName,labels,partitionKeys, clusteringColumn, TTL);
        ...
        tableName = scan.nextLine();
        Map<CqlIdentifier, DataType>colDefs=C.getColDefs(keyspaceName,tableName);
